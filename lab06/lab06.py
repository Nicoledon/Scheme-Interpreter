...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        item = Transaction(self.count ,self.balance - amount ,self.balance)
        self.count +=1
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            item = Transaction(self.count,self.balance,self.balance)
            self.count +=1
            self.transactions.append(item)
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        print("DEBUG Present_year:",Mint.present_year)
        print("DEBUG self.year:",self.year)
